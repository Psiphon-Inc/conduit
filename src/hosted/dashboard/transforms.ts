 ...
 *
 */
import type { TimeseriesDataPoint } from "@/src/common/timeseries";
import {
    RecentWindow,
    StatsLiveResponse,
...
interface DashboardRecentPoint {
    ts: string;
...
interface DashboardLiveSegment {
...
interface DashboardRoleAggregate {
    connectedUsers: number;
    connectingUsers: number;
