...
// Pin to psiphon-tunnel-core staging-client commit 96f782c6
require github.com/Psiphon-Labs/psiphon-tunnel-core v1.0.11-0.20260821154217-96f782c6f662

// Required for PSIPHON_ENABLE_INPROXY build tag - use Psiphon's forked DTLS library.
// This is automatically set up by 'make setup', which clones psiphon-tunnel-core.
